    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="https://www.facebook.com/nguyenmmmm" target="_blank" class="nav-link">LIÊN HỆ FB</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="https://zalo.me/thainguyen2006" target="_blank" class="nav-link">LIÊN HỆ ZALO</a>
                </li>
            </ul>
        </nav>
        <!-- /.navbar -->
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?=BASE_URL('Admin/Home');?>" class="brand-link">
                <center><img src="<?=$CMSNT->site('logo');?>" alt="<?=$CMSNT->site('tenweb');?>" width="100%"></center>
            </a>
            <!-- Sidebar -->
            <div class="sidebar">
                <!-- Sidebar Menu -->
