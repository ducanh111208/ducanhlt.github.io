                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Tên chủ nhân</label>
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="text" name="tenchunhan" value="<?=$CMSNT->site('tenchunhan');?>"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Config Gmail(SMTP)</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Config Bot Telegram</label>
                                <div class="col-sm-9">
                                    <div class="row clearfix">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" class="form-control" placeholder="Nhập Token"
                                                        name="bot_tele" value="<?=$CMSNT->site('bot_tele');?>"
                                                        placeholder="col-sm-6" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" class="form-control"
                                                        placeholder="Nhập Id Chat" name="id_chat_tele"
                                                        value="<?=$CMSNT->site('id_chat_tele');?>"
                                                        placeholder="col-sm-6" />
                                                </div>
                                            </div>
                                        </div>
